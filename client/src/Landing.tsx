    ...
    <main>
      ...
      <section className="section" style={{ background: "var(--problem-bg)", borderBottom: "3px solid var(--problem)" }}>
        <div className="container">
          ...
          <div className="section-content" style={{ color: "var(--step)" }}>
            ...
            <p>
              סצנת ריקודי העם מצליחה וכיפית — אבל אנחנו מאמינים שהפוטנציאל גדול בהרבה ואפשר לשפר בהרבה את הקיים (מכמה אלפי רוקדים שמסתדרים היטב בהרקדות הגדולות- לעשרות אלפים רבים).
            </p>
            <p>
      ...
      <section className="section" style={{ background: "var(--vision-bg)", borderBottom: "3px solid var(--vision)" }}>
        <div className="container">
          ...
          <div className="section-content" style={{ color: "var(--step)" }}>
            <p>
              <strong>אוסף ריקודים סטנדרטיים</strong> — כ־300 ריקודים, שכל קהילת הרוקדים משפיעה יחד על הרכב הרשימה. חציים זוגות וחציים מעגלים (מכל הסוגים והרמות), ועוד 150 מעגלים ו־150 זוגות לרוקדים ש"רוקדים רק מעגלים" או "רוקדים רק זוגות". דינמיות מתונה: פעם בחודש בכל קבוצה של 150 — נכנסים 2 ריקודים (ותיק + חדש) ויוצאים 2, כשההחלטה מתקבלת בדמוקרטיה של קהילת הרוקדים. כך בכל שנה מוחלפים 48 ריקודים, 24 מהם חדשים לגמרי — וריקוד חדש שנכנס הוא בוודאות רצוי על ידי רבים, ולא יילמד פעמיים־שלוש וייעלם. המספרים לא קדושים ויכולים להשתנות לפי רצון הרוקדים.(ויכול להיות שמעבר ל 300/600 ריקודים יוגדרו קבוצות של פחות מ 300 או יותר מ600 ריקודים )
            </p>
            <p>
            ...
            <p>
              ׳קהל היעד׳ של הרעיון הוא אומנם הרוקדים המתחילים , ברמות ביניים ,רוקדי עבר , וכו׳, אבל אנחנו מאמינים שהשינו יגדיל מאוד לאורך זמן את מספר הרוקדים, ואת הביקוש לריקודי עם , ייתן הזדמנויות למרקידים חדשים, ויאפשר יותר הרקדות גדולות ומבוקשות למרקידים הותיקים ( שיוכלו גם להגדיר את הייחודיות בהרקדות שלהם )
            </p>
          </div>
        </div>
      </section>
