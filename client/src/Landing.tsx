    ...
    <main>
      ...
      <section className="section" style={{ background: "var(--problem-bg)", borderBottom: "3px solid var(--problem)" }}>
        <div className="container">
          ...
          <div className="section-content" style={{ color: "var(--step)" }}>
            ...
            <p>
              המטרה היא לא לבטל את העושר או את הייחודיות של המרקידים. להפך: אם נדע טוב יותר מהם ריקודי הבסיס המשותפים ומהם הריקודים המיוחדים לכל הרקדה, נוכל לעזור להרבה יותר אנשים להיכנס למעגל, וגם לתת מקום ברור יותר לאופי הייחודי של כל מרקיד.
            </p>
            <p>
      ...
      <section className="section" style={{ background: "var(--step-bg)", borderBottom: "3px solid var(--step)" }}>
        <div className="container">
          ...
          <div className="section-content" style={{ color: "var(--step)" }}>
            <p>
              <strong>שלב ראשון, כשלושה חודשים:</strong> כל מרקיד יקבל שם משתמש וסיסמה, ויוכל להזין רשימה של עד 300 ריקודי מעגל ועד 300 ריקודי זוגות בטקסט חופשי. אפשר גם להוסיף הערות, להסביר מה מאפיין את ההרקדה, או ליצור איתי קשר ולשלוח קובץ בכל פורמט נוח.
            </p>
            <p>
              מערכת AI תנתח את המידע, תיתן יותר משקל למרקידים ותיקים ולמרקידים שיש להם הרקדות גדולות, ותאזן כך שיהיה ייצוג לכל ז׳אנר ולכל יוצר. אפשר להעיר על מספר הריקודים, אבל נראה לנו ש־300 (עם הרחבה טבעית ל־600) — כ־15 שעות ריקוד — זו התחלה טובה.
            </p>
            <p>
