      ...
      <section className="section" style={{ background: "var(--step-bg)", borderBottom: "3px solid var(--step)" }}>
        <div className="container">
          <LandingSection
            ...
            shortContent={(
              <>
                ...
                <p>
                  כדי להגיע לרוב המרקידים, נתחיל מרשימות והרקדות שפורסמו לציבור, ונאפשר לכל מרקיד לאמת, לעדכן או לבקש להסיר את פרטיו. מערכת AI תנתח את המידע, תזהה דפוסים, ותאזן בין ותק, גודל הרקדות, ז׳אנרים ויוצרים.
                </p>
                <p>
          ...
          >
            ...
            <p>
              את רשימת המרקידים הראשונית נבנה ממקורות ציבוריים: אתרי הרקדות, פרסומים של חוגים ומתנ״סים, פליירים, פסטיבלים וקישורים שיגיעו מהרוקדים ומהמרקידים עצמם. המידע ישמש להזמנה עניינית למהלך, וכל מרקיד יוכל לאמת את פרטיו, לתקן אותם, להצטרף או לבקש הסרה.
            </p>
            <p>
